...
## Usage
1. All .CSV files and scripts should be located in the same directory
2. Run finalmodel.R to train the model and generate predictions
3. Run mob_graphs.R to produce visualizations and statistical tests
...
Raven Pro: 
https://store.birds.cornell.edu/collections/frontpage/products/raven-pro-1-6-us-only

## Collaborators
Developed in collaboration with the University of Washington Bothell SU24 team.

Breeding season vocalizations have been provided by Dr. Wacker from the University of Washington Bothell
